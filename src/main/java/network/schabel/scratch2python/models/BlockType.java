...
public enum BlockType {
    ...
    public static BlockType fromDescription(String description) {
        for (BlockType blockType : values()) {
            if (java.util.Objects.equals(blockType.description, description)) {
                return blockType;
            }
        }
        throw new RuntimeException("Invalid BlockType: " + description);
    }
